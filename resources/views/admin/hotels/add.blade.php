        ...
        <div class="col-md-6 mt-4 mx-auto">
            <div class="card bg-danger">
                <div class="card-body">
                    ...
                    @endif
                    <h3 class="card-title text-white">Ajouter un hôtel</h3>
                    <form action="{{route('hotels.store')}}" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="name" class="text-white">Libelé*</label>
                            <input type="hidden" name="_token" value="{{Session::token()}}">
                            <input type="text" name="name" id="name" placeholder="Libelé" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="rooms" class="text-white">Chambres*</label>
                            <input type="number" name="rooms" id="rooms" placeholder="Chambres" class="form-control">
                        </div>
                        <div class="form-group">
