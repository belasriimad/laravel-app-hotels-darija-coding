        ...
        <div class="col-md-6 mt-4 mx-auto">
            <div class="card bg-danger">
                <div class="card-body">
                    ...
                    @endif
                    <h3 class="card-title text-white">Modifier une chambre</h3>
                    <form action="{{route('room.update',['id'=>$room->id])}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="numero" id="numero" placeholder="Numéro" value="{{$room->numero}}" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="floor" class="text-white">Etage*</label>
                            <input type="number" name="floor" id="floor" placeholder="Etage" value="{{$room->floor}}" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="status" class="text-white">Disponibilité*</label>
                            <select name="status" id="status" class="form-control">
                                <option value="1" {{($room->status == 1) ? 'selected' : ''}}>Résérvée</option>
